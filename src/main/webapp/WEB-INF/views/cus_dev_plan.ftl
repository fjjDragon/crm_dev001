	...
	<body style="margin: 1px">
		...
		<div id="toolbar">
			<#if show == 0 >
		        ...
		        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-kfcg" plain="true" onclick="updateSaleChanceDevResult()">开发成功</a>
		        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-zzkf" plain="true" onclick="stopSaleChanceDev()">终止开发</a>
		    </#if>
		</div>
